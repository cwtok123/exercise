...
public class ExerciseRecord extends Activity{
	...
	private static List<TraceLocation>locationsList = new ArrayList<TraceLocation>();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		avgSpeed = (TextView) findViewById(R.id.text_averageSpeed);
	 ...
	 */
	 private void init() {
		 ...
		 entityName = "小米4C";  //手机Imei值的获取，用来充当实体名
	...
	private void drawRealtimePoint(LatLng point){
		...
		avgSpeed.setText(avgSpeedNUM+"km/h");
